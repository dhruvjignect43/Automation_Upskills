...
//    }
     ...
     */
//    public void enterText(WebElement e, ContactData key) {
//        e.sendKeys((CharSequence) key);
//    }
     ...
     * @throws InterruptedException
     */
    public void hoverOver(WebElement e) throws InterruptedException {
        WebElement elementToHover = driver.findElement(By.xpath("//div[contains(@class,'productinfo') ]/p[text()='Blue Top']"));
        ...
        Thread.sleep(2000);
        // Click the element
        WebElement elementToClick = driver.findElement(By.xpath("//div[@class='product-overlay']//a[contains(@class,'add-to-cart')]"));
    ...
    public static void openNewTab(WebDriver driver) {
        // Use JavaScript executor to open a new tab
